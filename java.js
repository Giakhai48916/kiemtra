const sanpham = [
    {id: 1,name: "totem",gia: "3 diamond",img: "img/Totem.jpg",chitiet: "sống sót sau 1 đòn chí mạng"},
    ...
    {id: 5,name: "sheep",gia: "💀",img: "img/End Rod.jpg",chitiet: "trang trí và chiếu sáng"},
];
function inanh(){
